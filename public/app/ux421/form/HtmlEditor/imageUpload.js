Ext.define('Ext.ux.form.HtmlEditor.imageUpload', {
     ...
     */
    managerUrl: '/admin/ext-html-editor-upload/index',
...
/**
   ...
   */
    ...
    constructor: function (config) {
        ...
        this.submitUrl  = this.submitUrl+'/formId/'+this.formId;
        this.managerUrl = this.managerUrl+'/formId/'+this.formId;
        this.callParent();
    },
    ...
    beforeDestroy: function () {
		...
		//if (me.uploadDialog) me.uploadDialog.;
    ...
    _openImageDialog: function () {
        ...
        me.uploadDialog.on('imageloaded', function () {
			...
			if(Ext.isEmpty(newImage)) return;
